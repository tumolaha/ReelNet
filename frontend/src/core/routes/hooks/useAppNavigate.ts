...
export const useAppNavigate = () => {
  ...
  return {
    ...
    // Workspace routes
    toWorkspace: () => navigate(ROUTES.VIDEO_EDITOR.WORKSPACE),


    // Video Editor routes
    toVideoEditor: () => navigate(ROUTES.VIDEO_EDITOR.WORKSPACE),
    toVideoProject: (projectId: string) => 
      navigate(ROUTES.VIDEO_EDITOR.PROJECT.replace(':projectId', projectId)),
