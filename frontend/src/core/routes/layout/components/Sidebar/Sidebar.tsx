...
const menuItems = [
  { icon: HiHome, label: "Bắt đầu", active: true },
  { icon: HiTemplate, label: "Mẫu", badge: "Mới" },
  { icon: HiClock, label: "Bản nháp gần đây" },
  { icon: HiShare, label: "Chia sẻ và liên lịch" },
  { icon: HiCog, label: "Công cụ thần thành" },
];
